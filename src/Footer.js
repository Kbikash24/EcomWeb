...
const Footer = () => {
  return (<>
    <div style={{marginLeft:'44%', marginBottom:'20px'}}><Button  variant="warning" size="lg" style={{width:'230px'}}>Go to Cart</Button>
    </div>
        ...
        <Row>
          ...
          <Col className='icons'>
             <div className="text-right">
              ...
              <a href="https://youtube.in" target="_blank" rel="noopener noreferrer">
